...
-- application for ADD VALUE inside a transaction block).

ALTER TYPE "SignalSource" ADD VALUE IF NOT EXISTS 'chat_sentiment';
ALTER TYPE "SignalSource" ADD VALUE IF NOT EXISTS 'schedule_miss';
ALTER TYPE "SignalSource" ADD VALUE IF NOT EXISTS 'activity_drop';
ALTER TYPE "SignalSource" ADD VALUE IF NOT EXISTS 'cross_signal';
