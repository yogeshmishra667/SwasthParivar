...
import { processAnalyzeReading, type AnalyzeReadingJob } from "./analyze-reading.processor.js";

export type { AnalyzeReadingJob } from "./analyze-reading.processor.js";

export const analyzeReadingWorker: Worker<AnalyzeReadingJob> = createWorker<AnalyzeReadingJob>(
